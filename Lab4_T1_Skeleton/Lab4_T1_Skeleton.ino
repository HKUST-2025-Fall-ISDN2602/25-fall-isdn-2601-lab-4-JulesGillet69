...
#define TOUCH_PIN 15 // Replace the ? with the GPIO touch pin you selected 
#define THRESHOLD 30   // Replace the ? with the reading when the pin is touched from Lab 3
...
void setup() {
  ...
  pinMode(TOUCH_PIN, INPUT); // Set TOUCH_PIN as an output pin
}
